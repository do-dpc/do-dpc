...
@dataclass
class GammaDPCPredictorMatrices(DPCPredictorMatrices):
    r""""
...
@dataclass
class GammaDPCRegularizationMatrices(DPCRegularizationMatrices):
    """Currently there is no regularization cost function for the Gamma DPC algorithm."""


@DPC.register("GammaDPC")
class GammaDPC(DPC):
    """
    ...
    def __init__(self, ddpc_params: DPCParameters, training_data: InputOutputTrajectory):
        """
        Initializes the gamma DPC controller.
        """
        super().__init__(ddpc_params, training_data)
    ...
    def calculate_predictor_matrices(self) -> GammaDPCPredictorMatrices:
        """
        ...
        return GammaDPCPredictorMatrices(pinv_L_11=pinv(L_11), L_2_3=L_2_3, L_21=L_21, L_22=L_22, L_31=L_31, L_32=L_32)

    def calculate_regularization_matrices(self) -> GammaDPCRegularizationMatrices:
        return GammaDPCRegularizationMatrices()
    ...
    def calculate_closed_form_solution_matrices(self) -> Optional[DPCClosedFormSolutionMatrices]:
        ...
        Q_h = self.ddpc_params.Q_horizon
        R_h = self.ddpc_params.R_horizon
