...
from do_ddpc.control_utils.lti_systems import StateSpaceModel
...
from do_ddpc.ddpc.ddpc_utils import DPCUtils, StaticOnlyMeta
from do_ddpc.ddpc.mpc import MPC, MPCSystemMatrices
...
class MPCNFourSID(MPC):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, ddpc_params: DPCParameters, training_data: InputOutputTrajectory, n_block_rows: int):
        """
        Initializes the MPCNFourSID instance.

        Args:
            ddpc_params (DPCParameters): Controller parameters.
        ...
        super().__init__(ddpc_params, training_data, n_state=self.n_state)
