...
class MPCOracle(MPC):
    ...
    Attributes:
        ...
        ddpc_params (DPCParameters): Controller configuration parameters passed from the parent class.
    ...
    def __init__(
        ...
        super().__init__(ddpc_params, self._create_empty_training_data(100), n_state=n_state)
